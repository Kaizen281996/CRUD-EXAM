    ...
    <div className='bg-white rounded p-5'>  
        ...
        <form onSubmit={handleSubmit}> 
            ...
            <div className='mb-3'>     
                ...
                <input type="int" min="0" max="90" placeholder='Enter Age' className='form-control mt-1'
                 value={age} onChange={handleChangeAge} required/>           
            </div>  

            <div className='mb-3'>     
                <label htmlFor=""> Complte Address </label>    
            ...
            <button className='btn btn-success mt-3' style={{float:'right', borderRadius: '4px' }}> Update </button>  
